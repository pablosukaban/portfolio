        ...
        >
            ...
            <div className="space-y-10 px-1 md:px-10">
                ...
                <p className="text-base text-gray-200 md:text-lg">
                    {/* Будучи Junior фронтенд-разработчиком, я обладаю внушительным
                    арсеналом навыков в области HTML, CSS, JavaScript, React и
                    Tailwind. Я преуспел в разработке и поддержке отзывчивых
                    веб-сайтов, которые обеспечивают плавное взаимодействие с
                    пользователями. Мой опыт заключается в создании динамичных,
                    привлекательных интерфейсов посредством написания чистого и
                    ...
                    Как junior фронтенд-разработчик, я владею HTML, CSS,
                    JavaScript, React и Tailwind и успешно создаю и поддерживаю
                    отзывчивые веб-сайты. Мой опыт включает написание чистого и
