...
export const projectsList: ProjectDataType[] = [
    ...
    {
        title: 'FuturWear',
        text: 'FuturWear - 3D сайт, который позволяет пользователям создавать свои собственные дизайны футболок. Есть функция загрузки своих файлов или использования ИИ для создания уникальных дизайнов. Пользователи могут также скачать готовые футболки с выбранными дизайнами.',
        image: FuturWear,
